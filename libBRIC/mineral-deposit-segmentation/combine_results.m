...
Name = 'subjects_98';
Pfx = 'ad_t1w_mineral_stdint'; %'ad_t1w_mineral_test_withN4';
AdaptiveFlag = true;
...
[Subjects, J, J0, D, V, V_ref, CNR, q] = load_matdata([Name '_' Pfx '.mat']);
save([Name '_' Pfx '_edit_forR.mat'], 'J', 'J0', 'D', 'V', 'V_ref', 'CNR', 'q', '-v6');
