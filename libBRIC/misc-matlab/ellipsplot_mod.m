function [x_min, y_min, y_max] = ellipsplot_mod(center,covar,data, col, chi_val)
% This is a modified version of ellipsplot from the LIBRA library
...
%     end
     ...
     ylimit=sqrt(chi_val*covar(2,2)); %7.37776*covar(2,2));
...
%      title('Tolerance ellipse (97.5%)');         
     line(ellip(:,1),ellip(:,2),'Color',col);
 end